...
class CameraFullscreenViewController:UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        let url = URL(string:"https://zm-node-s2-01.prominic.net/zm/cgi-bin/nph-zms?scale=0&mode=jpeg&maxfps=30&monitor=74&user=Prominic&pass=PromZM2022&connkey=683710&rand=16666303660")
